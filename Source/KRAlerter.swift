...
public protocol KRAlerter {
    ...
    func alertYesNo(title : String?, message : String?, yesCompletion : (()->Void)?, noCompletion:(()->Void)?)
    ...
    func actionSheetPickPhoto(galleryCompletion: @escaping ()->Void, cameraCompletion: @escaping ()->Void)
